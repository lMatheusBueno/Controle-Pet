object FormHistorico: TFormHistorico
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Histotico de Receit'#250'arios'
  ClientHeight = 664
  ClientWidth = 1168
  Color = clBtnFace
  ...
  object Principal_Panel: TsPanel
    ...
    object EditCodigoHist: TsDBEdit
      Left = 19
      Top = 84
      Width = 70
      Height = 24
    ...
    object MemoReceituarioHist: TsDBMemo
      Left = 19
      Top = 201
      Width = 369
      Height = 221
  ...
  object GridPets: TDBAdvGrid
    ...
    ScrollBars = ssBoth
    TabOrder = 4
    OnDblClick = GridPetsDblClick
    ActiveRowShow = True
    ActiveRowColor = clMenuBar
