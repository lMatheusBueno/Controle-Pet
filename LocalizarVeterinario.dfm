object LocalizarVetForm: TLocalizarVetForm
  Left = 416
  Top = 198
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Localizar Veterin'#225'rio'
  ClientHeight = 320
  ClientWidth = 750
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object DBAVet: TDBAdvGrid
      ...
      OnDblClickCell = DBAVetDblClickCell
      OnColumnSize = DBAVetCvarolumnSize
    ...
    object sPanel1: TsPanel
      ...
      object Edit_LocalizarVet: TsEdit
        Left = 90
        Top = 8
        Width = 230
        Height = 29
        ...
        ParentFont = False
        TabOrder = 0
        OnChange = Edit_LocalizarVetChange
      end
      object sButton1: TsButton
        ...
        Font.Style = []
        ImageIndex = 2
        Images = CadastroPetForm.sAlphaImageList2
        ParentFont = False
        TabOrder = 1
