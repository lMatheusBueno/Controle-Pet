object AjudaForm: TAjudaForm
  ...
  object Edit_Ajuda: TsEdit
    ...
    ParentFont = False
    TabOrder = 0
    OnChange = Edit_AjudaChange
  end
  object Btn_BuscarAjuda: TsBitBtn
    Left = 450
    Top = 17
    Width = 112
    Height = 46
  ...
  object DsAjuda: TDataSource
    DataSet = DM.AjudaQuery
    Left = 327
    Top = 231
  end
end
