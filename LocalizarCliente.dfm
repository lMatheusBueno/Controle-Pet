object FomrLocalizarCliente: TFomrLocalizarCliente
  Left = 0
  Top = 0
  ...
  object Panel1: TPanel
    ...
    Align = alClient
    TabOrder = 0
    object GridClientes: TDBAdvGrid
      Left = 1
      Top = 1
      Width = 737
      Height = 278
  ...
  object Panel2: TPanel
    ...
    object Btn_OkCli: TsBitBtn
      ...
      ParentFont = False
      TabOrder = 1
      OnClick = Btn_OkCliClick
      ImageIndex = 4
      Images = CadastroPetForm.sAlphaImageList2
      SkinData.SkinSection = 'SPEEDBUTTON'
      SkinData.ColorTone = clBlack
    end
    object Edit_ClienteLocalizar: TsEdit
      Left = 78
      Top = 8
      Width = 230
      Height = 29
      ...
      ParentFont = False
      TabOrder = 2
      OnChange = Edit_ClienteLocalizarChange
    end
  end
